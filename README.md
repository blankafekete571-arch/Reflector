# Navigate — Structured Self-Reflection Exercise
...
**Auto-reload:**
```bash
uvicorn navigate:app --reload
```

**Change port:**
```bash
uvicorn navigate:app --port 8080
```
...
- Start server: `python navigate.py`
...
**Port already in use**
- Change port: `uvicorn navigate:app --port 8080`
